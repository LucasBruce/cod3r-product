...
// const EXAMPLE_DATA: ProductResponse[] = [
...
/**
 * Data source for the ProductResponseRead2 view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ProductRead2DataSource extends DataSource<ProductResponse> {
   ...
   */
  private getPagedData(data: ProductResponse[]): ProductResponse[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ProductResponse[]): ProductResponse[] {
